...
public class Client {
    ...
    public void sendMessage(MetaPacket packet) throws IOException {
        outputStream.write(packet.toByteArray(packet,key));
        outputStream.flush();
...
//
//
//        for(int i=1;i<=responsePacket.getFields().size();i++){
//            System.out.println("Message: " + responsePacket.getValue(i, String.class));
//        }
