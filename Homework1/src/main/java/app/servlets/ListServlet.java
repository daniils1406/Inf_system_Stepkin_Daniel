...
public class ListServlet extends HttpServlet {
    ...
    public static class ContentHolder {
        ...
        public ContentHolder(String previewResource, String mapping,String button,String discriptio, String pict) {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        contentHolders.forEach(contentHolder -> {
            //System.out.println(readResource(contentHolder.previewResource)+"aa");
            System.out.println(contentHolder.getMapping()+"aa");
            System.out.println(contentHolder.getButton()+"bb");
        });
